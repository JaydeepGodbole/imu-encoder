...
for (int i=0;i<=5;i++)
{
  payload[i]=int(xv/(pow(10,5-i)));
  xv%=int(pow(10,5-i));
}



//payload[0] = byte(val >> 24 & (11111111));//stuff.b[0];
//payload[1] = byte(val >> 16 & (11111111));//stuff.b[1];
//payload[2] = byte(val >> 8 & (11111111));//stuff.b[2];
//payload[3] = byte(val&&(11111111));//stuff.b[3];
//payload[4] = stuff.b[4];
//payload[5] = stuff.b[5];
//payload[6] = stuff.b[6];
//payload[7] = stuff.b[7];
